...
Model LoadModel(const char *fileName)
{
    ...
    if (model.meshCount == 0)
    {
        ...
        model.meshes[0] = GenMeshCube(1.0f, 1.0f, 1.0f, true);
#else
...
Mesh GenMeshPlane(float width, float length, int resX, int resZ, int upload)
{
    Mesh mesh = { 0 };
...
Mesh GenMeshCube(float width, float height, float length, int upload)
{
    Mesh mesh = { 0 };
